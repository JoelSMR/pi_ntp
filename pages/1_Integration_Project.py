...
API_BASE_URL = "http://localhost:8080/api/v1/products" # Placeholder for your specific sales endpoint
...
def fetch_data_from_api():
    ...
    full_url = f"{API_BASE_URL}" # Correct URL construction
    try:
